...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php?action=home">La Mayenne Sur Écoute</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=register">Créer un compte</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script src="/lfse/projet5_lfse/public/js/Dropdown.js"></script>
